...
---
Introduction: This was my first time reaching the Memory limit, with more than a gb of data and without being able to work it with Python without using chunks or doing some "tricks", however R came to save me and was able to work it easily. Both are strong tools but I prefer python, maybe I should use Polar for working and leave Pandas as a lot of Data Scientist decided to.
